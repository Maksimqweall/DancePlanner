...
const WEIGHTS = {
  avgPlace: 0.4,      // STRONG (35%) — База. Как высоко ты забираешься по турам.
  ...
  upsets: 0.1,        // HYPE (10%) — Апсеты. Наказал пару, которая выше тебя в мировом рейтинге? Получи буст!
  finalsPodium: 0.15,  // CLUTCH (10%) — Доминация. Умение доходить до медалей.
  worldRank: 0.1      // LOW (5%) — Якорь. Просто легкая поправка на глобальный статус пары.
} as const;
