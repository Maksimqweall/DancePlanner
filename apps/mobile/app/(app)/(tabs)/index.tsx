...
const styles = StyleSheet.create({
  ...
  welcome: { color: C.t3, fontSize: 12, fontWeight: '600', letterSpacing: 1.0, textTransform: 'uppercase' },
  userName: { color: C.t1, fontSize: 30, fontWeight: '900', letterSpacing: -0.8, marginTop: 4 },
  partnerChip: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
